...
/**
 * SerialsItemsSearch represents the model behind the search form of `app\modules\admin\models\SerialsItems`.
 */
class SerialsItemsSearch extends SerialsItems
{
    /**
     * {@inheritdoc}
     */
