...
/**
 * AnimeItemsSearch represents the model behind the search form of `app\modules\admin\models\AnimeItems`.
 */
class AnimeItemsSearch extends AnimeItems
{
    /**
     * {@inheritdoc}
     */
